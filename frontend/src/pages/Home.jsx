 ...
 return (
  <div className="w-full h-screen bg-[#0d1818] flex flex-col justify-center items-center gap-[20px]">
    ...
    <p className="text-white text-[20px]">
      Hey,{" "}
      <span className="text-[#0ce0e7] text-[25px] font-semibold">
        {userData.firstName}
      </span>
      , welcome to Ultimate Backend Course
    </p>

    <button className="bg-[#07c7e4] text-black px-[10px] py-[5px] rounded-lg" onClick={handleLogOut}>
      Log Out
    </button>
  </div>
);
